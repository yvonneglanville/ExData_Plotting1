...
##########################################################################################
plot(SetofData$Voltage,type = "l", xaxt ="n", ann =FALSE)
xValues <- c(0,1441,2880)
xLabels <- c("Thu", "Fri", "Sat")
...
axis(2, tick = TRUE, tck =-0.05)
##########################################################################################
plot(SetofData$Sub_metering_1,  type = "l", xaxt ="n", ann =FALSE)
...
legend("topright", y = NULL, c("sub_metering_1", "sub_metering_2", "sub_metering_3"),
       col = c(1,2,4), lty = 1 )
##########################################################################################
plot(SetofData$Global_reactive_power,type = "l", xaxt ="n", ann =FALSE)
xValues <- c(0,1441,2880)
xLabels <- c("Thu", "Fri", "Sat")
